    ...
    for (unsigned short iDV = 0; iDV < nDV; iDV++) {
      ...
      if ((Design_Variable[iDV] != NO_DEFORMATION) &&
        ...
        switch (Design_Variable[iDV]) {
          ...
          case FFD_CONTROL_POINT_NORMAL:     cout << "FFD (control point (normal)) <-> "; break;
          case FFD_NACELLE:           cout << "FFD (nacelle) <-> "; break;
          case FFD_GULL:              cout << "FFD (gull) <-> "; break;
          case FFD_GULL_NEW:          cout << "FFD (gull new) <-> "; break;
          case FFD_GULL_SIMPLE:       cout << "FFD (gull simple) <-> "; break;
          case FFD_GULL_NEW_IND:      cout << "FFD (gull new independent) <-> "; break;
          case FFD_GULL_ROT:          cout << "FFD (gull rotation) <-> "; break;
          case FFD_GULL_ROT_IND:      cout << "FFD (gull rotation independent) <-> "; break;
          ...
          case FFD_SWEEP:             cout << "FFD (sweep) <-> "; break;
        ...
        if ((Design_Variable[iDV] == FFD_CAMBER_2D) ||
            ...
            (Design_Variable[iDV] == FFD_GULL_NEW) ||
            (Design_Variable[iDV] == FFD_GULL_SIMPLE) ||
            (Design_Variable[iDV] == FFD_GULL_NEW_IND) ||
            (Design_Variable[iDV] == FFD_GULL_ROT_IND) ||
            (Design_Variable[iDV] == FFD_ANGLE_OF_ATTACK) ||
            (Design_Variable[iDV] == FFD_SWEEP) ||
            (Design_Variable[iDV] == FFD_TAPER)) nParamDV = 2;
        ...
        if (Design_Variable[iDV] == FFD_CONTROL_POINT_NORMAL) nParamDV = 4;
        if (Design_Variable[iDV] == FFD_CONTROL_POINT_2D) nParamDV = 5;
        if (Design_Variable[iDV] == ROTATION) nParamDV = 6;
        if ((Design_Variable[iDV] ==  FFD_CONTROL_POINT) ||
            (Design_Variable[iDV] ==  FFD_ROTATION) ||
            (Design_Variable[iDV] == FFD_GULL_ROT) ||
        ...
        for (unsigned short iParamDV = 0; iParamDV < nParamDV; iParamDV++) {
          ...
          if ((iParamDV == 0) &&
              ((Design_Variable[iDV] == NO_DEFORMATION) ||
               ...
               (Design_Variable[iDV] == FFD_CONTROL_POINT_NORMAL) ||
               ...
               (Design_Variable[iDV] == FFD_SWEEP) ||
               (Design_Variable[iDV] == FFD_TAPER))) cout << FFDTag[iDV];
