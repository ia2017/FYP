...
enum ENUM_PARAM {
  ...
  FFD_SWEEP = 25,            /*!< \brief FFD for Sweep (by Imran)>*/
  FFD_TAPER = 26,            /*!< \brief FFD for Taper (by Imran)>*/
  FFD_GULL_NEW = 27,            /*!< \brief FFD for Gull with blending function with rotating planes (by Imran)>*/
  FFD_GULL_SIMPLE = 28,         /*!< \brief FFD for Gull with blending function with normal planes (by Imran)>*/
  FFD_GULL_NEW_IND = 29,      /*!< \brief FFD for Gull with blending function with rotating planes (independent) (by Imran)>*/
  ...
  FFD_CONTROL_POINT_NORMAL = 100, /*!< \brief Free form deformation for 3D design (change a control point) normal (by Imran). */
  ANGLE_OF_ATTACK = 101,       /*!< \brief Angle of attack for airfoils. */
  FFD_GULL_ROT = 102,      /*!< \brief FFD for Gull with rotating function with rotating planes (by Imran)>*/
  FFD_GULL_ROT_IND = 103   /*!< \brief FFD for Gull with rotating function with rotating planes (independent) (by Imran)>*/
};
static const MapType<string, ENUM_PARAM> Param_Map = {
  ...
  MakePair("FFD_CONTROL_POINT_NORMAL", FFD_CONTROL_POINT_NORMAL)
  ...
  MakePair("FFD_GULL_NEW", FFD_GULL_NEW)
  MakePair("FFD_GULL_SIMPLE", FFD_GULL_SIMPLE) 
  MakePair("FFD_GULL_NEW_IND", FFD_GULL_NEW_IND)
  MakePair("FFD_GULL_ROT", FFD_GULL_ROT)
  MakePair("FFD_GULL_ROT_IND", FFD_GULL_ROT_IND)
  MakePair("FFD_TWIST", FFD_TWIST)
  MakePair("FFD_CAMBER", FFD_CAMBER)
  MakePair("FFD_THICKNESS", FFD_THICKNESS) 
  MakePair("FFD_SWEEP", FFD_SWEEP) 
