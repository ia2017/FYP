...
def read_aerodynamics( History_filename , nZones = 1, special_cases=[], final_avg=0, wnd_fct = 'SQUARE' ):
    ...
    # pull only these functions ---- changed edit
...
def get_dvMap():
    ...
    dv_map = { 0   : "NO_DEFORMATION"        ,
               ...
               51  : "ROTATE_GRID"           ,
               52  : "SCALE_GRID"            ,
               100 : "FFD_CONTROL_POINT_NORMAL",
               101 : "ANGLE_OF_ATTACK"       ,
               102 : "FFD_GULL_ROT"          ,
               103 : "FFD_GULL_ROT_IND"      }
...
def get_gradFileFormat(grad_type,plot_format,kindID,special_cases=[]):
    ...
    elif kindID == "FFD_CONTROL_POINT_NORMAL"  :
        header.append(r',"FFD_Box_ID","xIndex","yIndex","zIndex"')
