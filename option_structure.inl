   ...
   unsigned int i = 0;
    ...
    for (unsigned short iDV = 0; iDV < this->nDV; iDV++) {
      switch (this->design_variable[iDV]) {
        ...
        case FFD_CONTROL_POINT_NORMAL:   nParamDV[iDV] = 4; break;
        case FFD_NACELLE:          nParamDV[iDV] = 6; break;
        case FFD_GULL:             nParamDV[iDV] = 2; break;
        case FFD_GULL_NEW:         nParamDV[iDV] = 2; break;
        case FFD_GULL_SIMPLE:      nParamDV[iDV] = 2; break;
        case FFD_GULL_NEW_IND:     nParamDV[iDV] = 2; break;
        case FFD_GULL_ROT_IND:     nParamDV[iDV] = 2; break;
        case FFD_GULL_ROT:         nParamDV[iDV] = 7; break;
        case FFD_TWIST:            nParamDV[iDV] = 8; break;
        case FFD_ROTATION:         nParamDV[iDV] = 7; break;
        case FFD_SWEEP:            nParamDV[iDV] = 2; break;
        case FFD_TAPER:            nParamDV[iDV] = 2; break;
      ...
      for (unsigned short iParamDV = 0; iParamDV < nParamDV[iDV]; iParamDV++) {
        ...
        if ((iParamDV == 0) &&
            ((this->design_variable[iDV] == NO_DEFORMATION) ||
             ...
             (this->design_variable[iDV] == FFD_CONTROL_POINT_NORMAL) ||
             (this->design_variable[iDV] == FFD_NACELLE) ||
             (this->design_variable[iDV] == FFD_GULL) ||
             (this->design_variable[iDV] == FFD_GULL_NEW) ||
             (this->design_variable[iDV] == FFD_GULL_SIMPLE) ||
             (this->design_variable[iDV] == FFD_GULL_NEW_IND) ||
             (this->design_variable[iDV] == FFD_GULL_ROT_IND) ||
             (this->design_variable[iDV] == FFD_GULL_ROT) ||
             (this->design_variable[iDV] == FFD_TWIST) ||
             (this->design_variable[iDV] == FFD_ROTATION) || 
             (this->design_variable[iDV] == FFD_SWEEP) ||
             (this->design_variable[iDV] == FFD_TAPER) || 
