        ...
        for case in switch(this_param):
            ...
            if case("DV_PARAM"):
                ...
                for this_dvParam in info_General:
                    ...
                    if data_dict["DV_KIND"][0] in ['FFD_SETTING','FFD_ANGLE_OF_ATTACK','FFD_CONTROL_POINT','FFD_CONTROL_POINT_NORMAL','FFD_NACELLE','FFD_GULL','FFD_GULL_NEW','FFD_GULL_SIMPLE','FFD_GULL_NEW_IND','FFD_GULL_ROT','FFD_GULL_ROT_IND','FFD_TWIST_2D','FFD_TWIST','FFD_ROTATION','FFD_CAMBER','FFD_THICKNESS','FFD_CONTROL_POINT_2D','FFD_CAMBER_2D','FFD_THICKNESS_2D','FFD_SWEEP','FFD_TAPER']:
            ...
            if case("DEFINITION_DV"):
                ...
                for this_General in info_Unitary:
                    ...
                    if this_dvKind=='MACH_NUMBER' or this_dvKind=='AOA':
                        ...
                        if this_dvKind in ['FFD_SETTING','FFD_ANGLE_OF_ATTACK','FFD_CONTROL_POINT','FFD_CONTROL_POINT_NORMAL','FFD_NACELLE','FFD_GULL','FFD_GULL_NEW','FFD_GULL_SIMPLE','FFD_GULL_NEW_IND','FFD_GULL_ROT','FFD_GULL_ROT_IND','FFD_TWIST','FFD_TWIST_2D','FFD_TWIST_ANGLE','FFD_ROTATION','FFD_CAMBER','FFD_THICKNESS','FFD_CONTROL_POINT_2D','FFD_CAMBER_2D','FFD_THICKNESS_2D','FFD_SWEEP','FFD_TAPER']:
            ...
            if case("DEFINITION_DV") :
                ...
                for i_dv in range(n_dv):
                    ...
                    if not this_kind in ['AOA','MACH_NUMBER']:
                        output_file.write(" | ")
                        # params
                        if this_kind in ['FFD_SETTING','FFD_ANGLE_OF_ATTACK','FFD_CONTROL_POINT','FFD_CONTROL_POINT_NORMAL','FFD_NACELLE','FFD_GULL','FFD_GULL_NEW','FFD_GULL_SIMPLE','FFD_GULL_NEW_IND','FFD_GULL_ROT','FFD_GULL_ROT_IND','FFD_TWIST_ANGLE','FFD_TWIST','FFD_TWIST_2D','FFD_ROTATION','FFD_CAMBER','FFD_THICKNESS','FFD_CONTROL_POINT_2D','FFD_CAMBER_2D','FFD_THICKNESS_2D','FFD_SWEEP','FFD_TAPER']:
